...
public class Card_backup {
    // Fields
    private String type;
    private String color;
    // Constructors
    Card_backup(String typeX, String colorX) {
        type = typeX;
        color = colorX;
    }
    public Card_backup(int typeInt, int colorInt) {
    ...
    static boolean validCard(Card currentCard, Card cardToCheck) {
        return cardToCheck.getType().equals(currentCard.getType()) || cardToCheck.getColor().equals(currentCard.getColor()) || isSpecial(cardToCheck);
    }
    static boolean isSpecial(Card cardToCheck) {
        String type = cardToCheck.getType();
